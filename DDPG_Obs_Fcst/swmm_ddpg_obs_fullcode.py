...
from swmm_rl_multi_inp_forecast.swmm_Model_multi_inp_fcst import BasicEnv
...
# swmm_file = "C:/Users/Ben Bowes/PycharmProjects/LongTerm_SWMM/observed_data/obs_data_1month_all_old/08012019_08312019.inp"
swmm_file = "C:/Users/Ben Bowes/PycharmProjects/LongTerm_SWMM/observed_data/obs_test_data/1month_data_controlled/test_08012019_08312019.inp"
fcst = "C:/Users/Ben Bowes/PycharmProjects/LongTerm_SWMM/observed_data/obs_data_daily_fcsts/test_08012019_08312019.csv"
depth = 4.61
env = BasicEnv(inp_file=swmm_file, fcst_file=fcst, depth=depth)  # env with forecasts
...
agent.save_weights('swmm_rl_multi_inp_forecast/agent_weights/ddpg_swmm_weights2_{}_depth_{}.h5f'.format(train_steps, depth), overwrite=True)
...
plt.tight_layout()
# plt.show()
plt.savefig("C:/Users/Ben Bowes/PycharmProjects/swmm_rl_multi_inp_forecast/results_082019_fcst/ddpg_"
            + str(train_steps) + "steps_ctl_conrwd2_dlyfcst_fullcode.png", dpi=300)
plt.close()

print("testing and plotting 1 episode finished at: ", datetime.now())

# ############################### test agent on all data ###############################################################
test_dir = "C:/Users/Ben Bowes/PycharmProjects/LongTerm_SWMM/observed_data/obs_data_1month_all_controlled"
results_dir = "C:/Users/Ben Bowes/PycharmProjects/LongTerm_SWMM/observed_data/obs_test_data/1month_results"
fcst_dir = "C:/Users/Ben Bowes/PycharmProjects/LongTerm_SWMM/observed_data/obs_data_daily_fcsts"
...
for file in os.scandir(test_dir):
    if file.name.endswith('.inp'):
        ...
        result_list = [all_depths[0][0:, 0].tolist(), all_depths[0][0:, 1].tolist(), all_depths[0][0:, 2].tolist(),
                       ...
                       total_flood, st_max, j3_max, all_actions[0][0:, 0].tolist(), all_actions[0][0:, 1].tolist()]
