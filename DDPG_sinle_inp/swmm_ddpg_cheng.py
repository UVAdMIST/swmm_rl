...
from swmm_keras_rl.swmm_Model_cheng import BasicEnv
...
plt.tight_layout()
# plt.show()
plt.savefig("C:/Users/Ben Bowes/PycharmProjects/swmm_keras_rl/ddpg_" + str(train_steps) + "steps.png", dpi=300)
# plt.close()
